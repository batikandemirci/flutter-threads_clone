                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: NormalText(
                        text: "Computer Engineering student at D.U 3/4",
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(top: 5),
                      child: NormalText(
                        text: "In the process of becoming a personal trainer",
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(top: 5),
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 5),
                      child: NormalText(
                        text: "Freelance Flutter developer",
                      ),
                    ),
                    const SizedBox(
                      height: 10,
                    ...
                    Row(
                      children: [
                        TitleText(text: "batikandemirci.com"),
                        NormalText(
                          text: "....more",
                        ),
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        Stack(
                          children: [
                            ...
                            const CircleAvatar(
                              radius: 10,
                              backgroundImage:
                                  AssetImage("assets/profiles/profile17.png"),
                            ),
                            const Positioned(
                              left: 10,
                              child: CircleAvatar(
                                radius: 10,
                                backgroundImage:
                                    AssetImage("assets/profiles/profile16.png"),
                              ),
                            ),
                            const Positioned(
                              left: 20,
                              child: CircleAvatar(
                                radius: 10,
                                backgroundImage:
                                    AssetImage("assets/profiles/profile2.png"),
                              ),
                            ),
                          ],
                        ),
                        ...
                        NormalText(
                          text: "github.com/batikandemirci",
                        ),
                      ],
                    ),
                    const SizedBox(
